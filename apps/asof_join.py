...
quote_reader = InputMultiCSVDataset("quokka-asofjoin", "quotes", lineitem_scheme , stride = 128 * 1024 * 1024)
trades_reader = InputMultiCSVDataset("quokka-asofjoin", "trades", order_scheme , stride = 128 * 1024 * 1024)
