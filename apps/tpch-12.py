...
if sys.argv[1] == "small":
    ...
    orders = task_graph.new_input_csv("tpc-h-small","orders.tbl",order_scheme,{'localhost':8},batch_func=orders_filter, sep="|")
...
output_stream = task_graph.new_stateless_node({0:orders,1:lineitem},join_executor,{'localhost':4}, {0:"o_orderkey", 1:"l_orderkey"})
